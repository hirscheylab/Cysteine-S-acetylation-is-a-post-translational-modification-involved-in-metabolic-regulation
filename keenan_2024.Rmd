...
# convert to proper name format
# e.g. MDH1-C123
protein_site <- read_excel("Proteomics Data/All Acetyl-Cys Peptide groups _ all columns _ 20230212EKK20230126_BAT_6degVsRT_PD20230217.xlsx")
...
rt_vs_sixdeg_peptide_norm %>% 
  ...
  dplyr::mutate(treatment = if_else(str_detect(sample, "6deg"),
                                    "6deg",
                                    "RT"),
